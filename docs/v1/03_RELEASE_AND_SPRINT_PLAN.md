...
| 관련 에픽·스토리 | EP-00(DF-901~DF-939) 전체, EP-01~EP-22의 스프린트 배정(DF-001~DF-390), EP-23은 배정 없음 |
...
|---|---|---|---|---|---|
| P0 | S01–S05 | 78 | 5 | 83 (18+11+18+18+18) | 0 |
...
gantt
  ...
  axisFormat %m-%d
  section 법률·처리방침
  G-04 법률 자문 의뢰·회신(DF-908)      :g04, 2026-10-02, 42d
...
|---|---|---|---|---|---|---|---|---|
| 법률 | G-04 법률 의견(DF-908: Q-04, Q-05, Q-07, Q-21, Q-24) | 실데이터 투입, soapV2·bodyComposition 개방(DF-925) | 목표 11-27(S09), 한계 12-18(S12) | 회신 6주 + 동의 문서 반영 1주(ASM-03-01, ASM-03-02) | 10-02(S01) 발송 | 목표 기준 **10-08(목)**, 한계 기준 **10-30(금)** | 목표 대비 약 1주, 한계 대비 4주 | 합성 데이터 개발 계속. 12-18까지 개방 못 하면 P1a 자체 사용이 밀리므로 P1a 종료 검토를 주 단위로 연기(§11) |
| 법률 | Q-24 보유기간 N | G-04 통과 자체 | 법률 회신과 같음 | 법률 회신에 포함 | S01 의뢰서에 명시 | 10-08 | 위와 같음 | 없음. N이 없으면 G-04 미통과(PRD Q-24). DF-133은 N 설정값 비활성 기본으로 개발만 진행 |
| 처리방침 | G-09 처리방침·리전(DF-909, Q-08) | 위와 같음(G-04와 묶음) | 11-27 / 12-18 | 초안 1주, 법률 검토는 G-04와 동시, 게시 1일(ASM-03-02) | S03 초안 | **11-13(금)** 초안 확정 | 약 2주 | 리전(Q-08) 확인은 S03 첫날 콘솔에서 먼저 한다 |
...
| Firebase | Storage 교차 조회 권한(DF-906) | DF-038(S03), DF-023(S04) | 10-12 | 30분 | S03 첫날 | 10-12 | 0일 | S-09 실패 시 ADR-007 대안 결정(DF-038) |
...
flowchart LR
  ...
  N[DF-908 법률 의뢰<br/>S01] --> O[G-04·G-09<br/>S08]
...
| 게이트(준주경로) | DF-908(S01) → 법률 회신(목표 S07~S08) → DF-909·DF-032 게시 → DF-925(S09) → 자체 사용 | 목표 기준 1주, 한계 기준 3주 | 법률 회신이 12-11을 넘기면 P1a 종료가 밀린다 |
