...
1. 사전 확인: 운영 `(default)`(`nam5`)에 테스트 데이터만 있음을 다시 확인한다(컬렉션 이름과 문서 수만 본다). 운영 규칙이 전부 거부라 회원 앱 클라이언트가 읽고 쓰는 데이터는 없다([G-01 후속 1](../evidence/G-01.md#후속-조치)). 테스트 데이터라 내보내기로 보존하지 않는다.
...
| v1.1 | 2026-09-25 | CJH(AI 에이전트, 소유자 결정 기록) | 소유자 결정 2026-09-25 반영: DEC-19 서울 리전 전환 [DF-942](#df-942) 카드 추가(S01, 1점), DF-905·DF-906·DF-909 의존에 DF-942, DF-931 의존에 DF-043, DF-908 보류(S03 발송 계획, 최신 10-30), DF-930 증빙 링크, §1·§2 표 갱신 |
