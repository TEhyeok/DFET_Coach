    ...
    return CupertinoPageScaffold(
      ...
      navigationBar: CupertinoNavigationBar(
        ...
        leading: CupertinoButton(
          ...
          child: Icon(CupertinoIcons.back, color: context.wellness.textPrimary),
          onPressed: () {
        ...
        trailing: _isUploading
            ...
            : CupertinoButton(
                ...
                child: const Text('제출',
                    style: TextStyle(color: PremiumColors.primary)),
              ),
      ),
      child: SafeArea(
        child: ListView(
                        ...
                        child: Column(
                          ...
                          children: [
                            const Icon(CupertinoIcons.camera,
                                color: PremiumColors.primary, size: 32),
                        ...
                        child: Column(
                          ...
                          children: [
                            const Icon(CupertinoIcons.photo,
                                color: PremiumColors.secondary, size: 32),
                            const SizedBox(height: 8),
                            Text('갤러리에서 선택',
                                style: TextStyle(
                                    color: context.wellness.textPrimary)),
